...
(define (problem p1-dangeon)
  ...
  (:init
        ...
        ; (not (is-destroyed sword1))
        
        ; (not (is-destroyed cell1))
        ; (not (is-destroyed cell2))
        ; (not (is-destroyed cell3))
        ; (not (is-destroyed cell4))
        ; (not (is-destroyed cell5))
        ; (not (is-destroyed cell6))
        ; (not (is-destroyed cell7))
        ; (not (is-destroyed cell8))
        
        ; (not (trap-disarmed cell2))
  )
  (:goal (and
